...
| master.resources.limits.ephemeral-storage | string | `"2Gi"` |  |
| master.resources.limits.memory | string | `"128Mi"` |  |
| master.resources.requests.cpu | string | `"100m"` |  |
| master.resources.requests.ephemeral-storage | string | `"50Mi"` |  |
...
| worker.resources.limits.ephemeral-storage | string | `"2Gi"` |  |
| worker.resources.limits.memory | string | `"512Mi"` |  |
| worker.resources.requests.cpu | string | `"100m"` |  |
| worker.resources.requests.ephemeral-storage | string | `"50Mi"` |  |
